...
print OUT "<title>", "Timer_q documentation -- functions", "</title>", "\n";
print OUT $html_body;
print OUT "<table width=\"100%\"><tr><td bgcolor=\"#DDFFDD\">", 
  "<h1>", "Timer_q documentation -- functions", "</h1>", "\n";
...
print OUT $html_header;
print OUT "<title>", "Timer_q documentation -- constants", "</title>", "\n";
print OUT $html_body;
print OUT "<table width=\"100%\"><tr><td bgcolor=\"#DDFFDD\">", 
  "<h1>", "Timer_q documentation -- constants", "</h1>", "\n";
